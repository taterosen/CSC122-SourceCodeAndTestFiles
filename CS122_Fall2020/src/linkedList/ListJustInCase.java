...
public class ListJustInCase<E> implements List<E>
{
	...
	public boolean contains(E item) 
	{
		...
		{
			while(!ptr.data.equals(item) && count < numberOfEntries)
				count++;
		}
	...
	public E remove(int pos) 
	{
		...
		else
		{
			Node ptr = head;
			int i = 1;
			while(ptr.next != null && i < numberOfEntries - 1 && i < pos)
			{
				ptr = ptr.next;
				i++;
			}
